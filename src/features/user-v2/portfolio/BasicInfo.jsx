...
function BasicInfo() {
  ...
  return (
    <div className="rounded-md cards h-full p-4 bg-white relative flex justify-between gap-4">
      <div className="w-1/4">
        <PortfolioStepDisplay step={1} percent={0} label="basic information" />
      </div>
      <div className="w-3/4 px-4 overflow-y-scroll">
        <div>
          ...
          <input
            ...
            id="name"
            placeholder="Name"
            className="py-2 px-4 text-gray-400 text-base font-medium rounded-lg w-full bg-gray-200/50"
        ...
        <div>
          <h2 className="text-sm font-semibold py-2">
            Present Address<span className="text-xs text-red-600">*</span>
            <span className="text-xs text-gray-600/50">(According to NID)</span>
          </h2>
          <input
            type="text"
